...
// Google refuses to run its own sign-in inside an embedded app WebView (a
// security policy on Google's end — shows an error page rather than
// completing), so "Continue with Google" is a dead end on native. Hidden
// there rather than disabled instance-wide, so it stays available on the
// web build, where it works fine in a real browser tab.
const clerkAppearance = Capacitor.isNativePlatform()
